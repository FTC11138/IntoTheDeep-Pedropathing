...
public class DriveConstants {
    ...
    private static double xMovement = 73.3838;
    private static double yMovement = 59.0129;
    ...
    public static double forwardZeroPowerAcceleration = -28.4007;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -71.3449;
    ...
    public static double zeroPowerAccelerationMultiplier = 8;
