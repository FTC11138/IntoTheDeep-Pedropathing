...
public class Localizer extends org.firstinspires.ftc.teamcode.pedroPathing.localization.Localizer {
    ...
    public static double TURN_TICKS_TO_RADIANS = 0.00205;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public Localizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(2, 8, 0);
        rightEncoderPose = new Pose(2, -8, 0);
        strafeEncoderPose = new Pose(-2.25, 7.75, Math.toRadians(90));
